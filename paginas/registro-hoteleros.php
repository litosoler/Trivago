...
<body>
   ...
   <nav class="navbar  navbar-fixed-top" style="background-color: #ffffff; border-color: #9a9d9f;" >
	 <div class="container " style="padding: 12px; height: 60px">  
	 <div class=row>
     <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
     	<a href="https://www.trivago.es/hotelmanager/"> <img src="../img/trivagoHM.png" style="margin-top: 5px"> </a>
     </div>
   
     	
     
      <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12" style="padding-left: 205px">
     	
     
	  <ul class="nav nav-pills" >
	  <li class="nav-item" >
	    <a class="nav-link " href="#" style="color: #f48f00;""> <img src="../img/pro.png">  </a>
	  </li>
	  <li class="nav-item"  style="border-color: 2px">
	    <a class="nav-link" href="#" style="color: #000000; border: 2px; border-color: #000000;">Iniciar Sesion</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" href="file:///C:/xampp/htdocs/Trivago/registro%20hoteleros.html" style="color: #000000;">Registrarse</a>
	  </li>
	  <li class="nav-item" style="border: 1px;">
	    <a class="nav-link " style="color: #f48f00" href="#">Llamar </a>
    ...
    <div style="background-color: #9a9d9f; height: 1px; border-color:#9a9d9f; " >
    	
    </div>
  </nav>


  <div class="container-fluid" style="padding-bottom: 25px; padding-top: 75px;">
  <div class="row">
  ...
  <div class="card-block">
    <h3 class="card-title" style="color:#ffffff; font-weight: 600; padding-left: 20px">Encuentre su hotel y cree una cuenta gratis</h3>
    <p class="card-text" style="color:#ffffff; font-size-adjust: 15; padding-left: 20px" > <br>Está a un paso de empezar a gestionar sus hoteles en trivago. Rellene el formulario para ayudarnos a verificar su identidad. Sus datos personales están a salvo y no los compartiremos.</p>
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border-style: ridge;padding-bottom: 15px; width: 600px; margin-top: 22px"  > 
  		<div style="padding-left: 20px;">
  			<table  >
                ...
                <input type="text" class="form-control" name="nombre_hotel" id="txt_nomehotel" placeholder="Busque su Hotel" style="width: 450px; height: 50px;" >
 	 			   		<p class="hint-formfield p-0">
  				   		<small>Puede seleccionar mas de un hotel</small></td>
  			   ...
  			   <tr>
  			   		<td colspan="2">
  			   			...
  			   			<select name="selcttra" class="form-control" id="slc_tra" class="form-control" style="height: 50px; width: 450px;"> 
  			   ...
  			   <tr>
  			   		<td colspan="2">
  			   				...
  			   				<select  name="cargo" id="cargo_id" class="form-control" style="height: 50px; width: 450px;">
  			   				<option value="1">
                                    Propietario
  			   	...
  			   	<tr>
                       ...
                       <label  for="nombre-usr"> Nombre</label>
                    	<input type="text" class="form-control" id="nombre-usr" style="width: 212px; height: 50px;" >
                       </div>
                     ...
                     <td>
  			   	    <div class="form-group" style="padding-right: 80px">
  						...
  						<input type="text" class="form-control" id="apellido-usr" style="width: 212px; height: 50px"> 
						</div>
  			   	...
  			   	<tr>
  			   		<td><strong> Telefono<br></strong>
  			   		     
  			   			 <select name="slcttel" id="slct_tel" style="height: 50px; width: 212px">
  			   			 <option value="AF">
                                    Afganistán (+93)
  			   		...
  			   		<td style="padding-top: 20px; margin: 25px; padding-left: " >
  			   			<input type="text" class="form-control" name="txt_tel" id="txt_tel" placeholder="32364307 " style="width: 212px; height: 50px;">
  			   		</td>
  			   	</tr>
  			   	...
  			   	<tr>
  			   		<td colspan="2">
  			   			...
  			   			<input type="E-mail" class="form-control" name="emailof" id="correo" placeholder="E-mail@trivago.com" style="height: 50px; width: 450px">
  			   		</td>
  			   	</tr>
  			   	...
  			   	<tr>
  			   		<td colspan="2">
  			   		    ...
  			   		    <input type="password" class="form-control" name="password_txt" id="pwd" placeholder="*******" style="height: 50px; width: 450px">
  			   		    <p>
  			   ...
  			   <tr>
  			    	<td colspan="2">
  			    	     <input type="checkbox" name="chk_boletin" id="chk_boletin">Deseo recibir el boletin de noticias<br><br>
