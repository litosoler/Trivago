...
ALTER TABLE tbl_opniones ADD CONSTRAINT tbl_opniiones_pk PRIMARY KEY ( codigo_categoria,codigo_hotel );
...
ALTER TABLE tbl_opniones ADD CONSTRAINT tbl_opniiones_tbl_categoria_fk FOREIGN KEY ( codigo_categoria )
    REFERENCES tbl_categoria ( codigo_categoria );

ALTER TABLE tbl_opniones ADD CONSTRAINT tbl_opniiones_tbl_hoteles_fk FOREIGN KEY ( codigo_hotel )
    REFERENCES tbl_hoteles ( codigo_hotel );

ALTER TABLE tbl_opniones ADD CONSTRAINT tbl_opniiones_tbl_persona_fk FOREIGN KEY ( codigo_usuario )
    REFERENCES tbl_usuario ( codigo_usuario );
